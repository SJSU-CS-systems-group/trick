...
fun AndroidApp(
        ...
        MaterialTheme(
                ...
                Surface {
                        ...
                        val discoveryStatus = remember {
                                mutableStateOf("Waiting for permissions...")
                        }
                        ...
                        LaunchedEffect(permissionsGranted) {
                                if (permissionsGranted) {
                                        while (true) {
                                                ...
                                                connectedPeerIds.addAll(
                                                        wifiAwareService.getConnectedPeers()
                                                )
                        ...
                        LaunchedEffect(permissionsGranted) {
                                if (permissionsGranted) {
                                        ...
                                        wifiAwareService.startDiscovery { chatMessage ->
                                                ...
                                                // (encryption_version field present)
                                                val wasEncrypted =
                                                        chatMessage.encryption_version != null
                                                ...
                                                if (photoContent != null) {
                                                        val imageData =
                                                                photoContent!!.data_.toByteArray()
                                                        val filename =
                                                                photoContent!!.filename ?: "image"
                                                        debugLogs.add(
                                        ...
                                        debugLogs.add(
                                                "[UI] Waiting for user to grant permissions..."
                                        )
                                }
                        }
                        ...
                        fun refreshDiscovery() {
                                debugLogs.add(
                                        "[UI] Manual refresh triggered - stopping discovery..."
                                )
                                ...
                                wifiAwareService.startDiscovery { chatMessage ->
                                        ...
                                        if (textContent != null) {
                                                val msg = textContent.text
                                                debugLogs.add(
                                                        "[App] Message received (refresh): $msg"
                                                )
                        ...
                        if (showKeyExchange) {
                                ...
                                MessagingScreen(
                                        ...
                                        onSendPicture = { imageData, filename, mimeType ->
                                                debugLogs.add(
                                                        "[App] Sending picture: $filename (${imageData.size} bytes)"
                                                )
                                        ...
                                        onNavigateToKeyExchange = { showKeyExchange = true },
                                        onNavigateToContacts = { showMessaging = false }
                                )
                        } else {
                                // Show ContactsLandingPage as the landing page
                                ContactsLandingPage(
