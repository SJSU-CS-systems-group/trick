package org.trick.metrics

import android.content.BroadcastReceiver
import android.content.Context
import android.content.Intent
import android.util.Log
import org.trick.screens.messaging.AndroidWifiAwareManager
 ...
 *
 * Usage — burst test:
 *   adb shell am broadcast -a org.trick.STRESS_TEST \
 ...
 *   adb shell am broadcast -a org.trick.STRESS_TEST_CANCEL
 */
class StressTestReceiver : BroadcastReceiver() {

    companion object {
        private const val TAG = "PerfStressTest"
        const val ACTION_STRESS_TEST = "org.trick.STRESS_TEST"
        const val ACTION_CANCEL = "org.trick.STRESS_TEST_CANCEL"
